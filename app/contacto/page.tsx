      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-12">
            {/* Form */}
            <div className="lg:col-span-3 contacto-animate">
              <form
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="contacto-animate bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
              ...
              <a
                ...
                className="contacto-animate flex items-center justify-center gap-3 bg-green-500 hover:bg-green-600 text-white p-5 rounded-2xl font-semibold transition-all hover:shadow-lg hover:shadow-green-500/25"
              >
