      ...
      <section className="pt-32 pb-16 bg-gradient-to-br from-primary-900 via-primary-800 to-primary-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm text-white/90 font-medium">Contacto</span>
          </span>
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto">
            Cuéntenos sobre las necesidades de su empresa y uno de nuestros ejecutivos le contactará a la brevedad.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-5 gap-12">
            <div className="lg:col-span-3">
              <form onSubmit={handleSubmit} className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100">
                <div className="grid sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-dark-900 mb-2">Teléfono *</label>
                  ...
                  <div>
                    ...
                    <input type="text" value={formData.company} onChange={(e) => setFormData({ ...formData, company: e.target.value })} className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 outline-none transition-all" placeholder="Nombre de su empresa" />
                  </div>
                </div>
                <div className="mt-5">
                  <label className="block text-sm font-semibold text-dark-900 mb-2">Servicio de interés *</label>
                  <select required value={formData.service} onChange={(e) => setFormData({ ...formData, service: e.target.value })} className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 outline-none transition-all bg-white">
                ...
                <div className="mt-5">
                  <label className="block text-sm font-semibold text-dark-900 mb-2">Mensaje</label>
                  <textarea rows={4} value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })} className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 outline-none transition-all resize-none" placeholder="Cuéntenos sobre las necesidades de su empresa..." />
                </div>
                <button type="submit" className="mt-6 w-full bg-primary-800 hover:bg-primary-900 text-white py-4 rounded-xl font-semibold text-lg transition-all hover:shadow-lg hover:shadow-primary-800/25">
                  Enviar Mensaje
                </button>
                {isSubmitted && (
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                <h3 className="font-bold text-dark-900 text-lg mb-4">Información de Contacto</h3>
              ...
              <a href="https://api.whatsapp.com/send?phone=523312345678&text=Hola,%20me%20interesa%20una%20demostración%20de%20sus%20servicios" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-3 bg-green-500 hover:bg-green-600 text-white p-5 rounded-2xl font-semibold transition-all hover:shadow-lg hover:shadow-green-500/25">
