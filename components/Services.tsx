        ...
        <div ref={contentRef} key={activeTab}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {activeCategory.services.map((service, i) => (
              <div
                key={service.title}
                className="group relative bg-white p-6 rounded-2xl border border-gray-100 hover:border-primary-200 hover:shadow-xl hover:shadow-primary-100/30 transition-all duration-300 hover:-translate-y-1"
              >
