    ...
    <div ref={pageRef}>
      ...
      <section className="pt-32 pb-16 bg-gradient-to-br from-primary-900 via-primary-800 to-primary-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto">
            ...
            Complete el formulario y le contactaremos para agendar su demostración personalizada.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="demo-animate bg-white p-8 sm:p-10 rounded-3xl shadow-lg border border-gray-100">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold text-dark-900 mb-2">
                Formulario de Solicitud de Demo
              </h2>
              <p className="text-gray-500">
                Complete sus datos y le contactaremos en menos de 24 horas.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="mt-6 w-full bg-accent-500 hover:bg-accent-600 text-white py-4 rounded-xl font-semibold text-lg transition-all hover:shadow-lg hover:shadow-accent-500/25"
              >
              ...
              <p className="mt-4 text-xs text-gray-400 text-center">
                Al enviar, acepta que Proceeding Consulting AC se pondrá en
            ...
            {[
              {
                icon: "⚡",
                title: "Rápido",
                description: "Le contactamos en menos de 24 horas",
              },
              {
                icon: "🎯",
                title: "Personalizado",
                description: "Demo adaptada a las necesidades de su empresa",
              },
              {
                icon: "💰",
                title: "Sin Compromiso",
                description: "Demostración completamente gratuita",
              },
            ].map((benefit) => (
              <div
                key={benefit.title}
                className="demo-animate text-center p-6 bg-white rounded-2xl shadow-lg border border-gray-100"
              >
